...
<div class="row custom-row">
    <div class="col-sm-4-7 mt-3 mt-md-0 custom-col">
    ...
    <div class="col-sm-3-7 mt-3 mt-md-0 custom-col">
...
<style>
    ...
    .col-sm-4-7 {
        flex: 4 0 0; /* 4 parts of the 7 total */
    }
    .col-sm-3-7 {
        flex: 3 0 0; /* 3 parts of the 7 total */
    }
    .custom-img {
        height: 100%;
